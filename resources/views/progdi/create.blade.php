...
<head>
    <meta charset="UTF-8">
    <title>Hal Tambah Program Studi</title>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nm_fakultas" class="form-control" placeholder="Nama Fakultas">
                        @error('nm_fakultas')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nm_progdi" class="form-control" placeholder="Nama Program Studi">
                        @error('nm_progdi')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
